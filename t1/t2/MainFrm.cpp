	...
	CCreateContext* pContext)
{
	...
	if (!m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(CLeftView), CSize(100, 100), pContext) ||
		!m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(Ct2View), CSize(100, 100), pContext))
	{
...
Ct2View* CMainFrame::GetRightPane()
{
	CWnd* pWnd = m_wndSplitter.GetPane(0, 1);
	Ct2View* pView = DYNAMIC_DOWNCAST(Ct2View, pWnd);
	return pView;
}
...
void CMainFrame::OnViewStyle(UINT nCommandID)
{
	...
	// if the right-hand pane has been created and is a Ct2View,
